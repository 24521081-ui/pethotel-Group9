    ...
    <div class="container">
        <div class="about-wrapper">
            <div class="about-image">
                <img src="{{ asset('assets/client/images/about-petstay.jpg') }}" alt="Về PetStay Hotel">
            </div>
...
<section class="home-rooms">
    <div class="container">
        ...
        <div class="room-list">
            <div class="room-card">
                <img src="{{ asset('assets/client/images/room-standard.jpg') }}" alt="Phòng Thường">

                <div class="room-content">
                    <h3>Phòng Thường</h3>
                    <p>Sinh hoạt chung, tiêu chuẩn cơ bản, phù hợp cho lưu trú ngắn hạn</p>

                    <a href="{{ url('/rooms/standard') }}" class="room-btn">
                        Xem chi tiết
                    </a>
                </div>
            </div>
            ...
            <div class="room-card">
                <img src="{{ asset('assets/client/images/room-vip.jpg') }}" alt="Phòng VIP">
            ...
            <div class="room-card">
                <img src="{{ asset('assets/client/images/room-luxury.jpg') }}" alt="Phòng Luxury">
