...
<section class="cat-hero" style="background-image: url('{{ asset('assets/client/images/cat-hero.jpg') }}')">
    ...
    <div class="cat-container">
        ...
        <div class="cat-room-card">
            <div class="cat-room-image">
                <img src="{{ asset('assets/client/images/cat-room-standard.jpg') }}" alt="Phòng Thường cho mèo">
            </div>
            ...
            <div class="cat-room-content">
                ...
                <a href="{{ url('/booking') }}" class="cat-room-btn">
                    Chọn phòng này
                </a>
            </div>
        </div>
        ...
        <div class="cat-room-card reverse">
            <div class="cat-room-image">
                <img src="{{ asset('assets/client/images/cat-room-vip.jpg') }}" alt="Phòng VIP cho mèo">
            </div>
        ...
        <div class="cat-room-card">
            <div class="cat-room-image">
                <img src="{{ asset('assets/client/images/cat-room-luxury.jpg') }}" alt="Phòng Luxury cho mèo">
            </div>
...
<section class="cat-cta">
    <div class="cat-container">
        <h2>Để bé mèo được nghỉ dưỡng an toàn</h2>
        <p>Đặt phòng ngay để nhận ưu đãi hấp dẫn</p>

        <a href="{{ url('/booking') }}" class="cat-cta-btn">
            Đặt phòng ngay
        </a>
    </div>
</section>
