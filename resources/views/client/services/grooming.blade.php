...
<section class="grooming-hero" style="background-image: url('{{ asset('assets/client/images/grooming-hero.jpg') }}')">
        ...
        <div class="grooming-package-list">
            ...
            <div class="grooming-package-card">
                <div class="grooming-package-image">
                    <img src="{{ asset('assets/client/images/grooming-basic.jpg') }}" alt="Gói cơ bản">
                </div>
            ...
            <div class="grooming-package-card reverse">
                <div class="grooming-package-image">
                    <img src="{{ asset('assets/client/images/grooming-spa.jpg') }}" alt="Gói Spa">
                </div>
            ...
            <div class="grooming-package-card">
                <div class="grooming-package-image">
                    <img src="{{ asset('assets/client/images/grooming-premium.jpg') }}" alt="Gói cao cấp">
                </div>
...
<section class="grooming-cta">
    <div class="grooming-container">
        <h2>Để thú cưng luôn sạch sẽ và đáng yêu</h2>
        <p>Đặt lịch Grooming ngay để bé được chăm sóc tận tâm</p>

        <a href="{{ url('/booking') }}" class="grooming-cta-btn">
            Đặt lịch ngay
        </a>
    </div>
</section>
